      ...
      <div className="home">
        <div className="greeting">
          <div className="text">
            ...
            <p>
              &#128073;Using Git to track, regulate, and revise code changes.
            </p>
            <p>
            ...
            <p>
              &#128073;Know how to deploy codes. Deploying code entails putting
              it in the cloud, using SaaS providers like Amazon Web Services,
              and so on.
            </p>
            ...
            <div className="webDev">
              <div className="text">
                ...
                <ul>
                  ...
                  <li>
                    &#128073;Styling website front end components using SASS,
                    CSS
                  </li>
                  <li>
